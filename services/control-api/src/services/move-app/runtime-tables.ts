...
export const MOVE_APP_RUNTIME_TABLES = [
  ...
  'actor_usage_logs',
  'mcp_tool_call_log',
  'enrichlayer_usage_logs',
  'enrichlayer_profile_cache',
...
export const MOVE_APP_EXCLUDED: Record<string, string> = {
  ...
  enrichlayer_email_lookups: 'pending rows reference an EnrichLayer webhook callback URL pinned to source region; copying would orphan in-flight lookups. Acceptable v1 — moves are infrequent, pending lookups complete within seconds.',
